...
BASE_PATH = '/home/lyf/data/taizhou/base_map'
BASE_INFO_PATH = '/home/lyf/data/taizhou/base_map_info.txt'
...
class ImageFolderDataset(Dataset):
        ...
        with open(self.base_info_path, 'r') as file: 
            for line in file:
                ...
                for i in range(len(patches_list)):
                    place_ids[len_place+i] = [image_name, i]
    ...
    def __getitem__(self, index):
        ...
        print(place_id)
        imgs = []
        img_path = os.path.join(self.base_path, place_id[0])
    ...
    @staticmethod    
    def random_crop(image, min_size=200, max_size=2500):
        """
