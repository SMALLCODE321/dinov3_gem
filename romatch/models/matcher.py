        ...
        *args,
        ...
        with torch.no_grad():
            ...
            if self.upsample_preds:
                ...
                im_A, im_B = test_transform((im_A_path, im_B_path))
                # im_A, im_B = test_transform(Image.fromarray(im_A_path.cpu().detach().numpy()),Image.fromarray(im_B_path.cpu().detach().numpy()))
