...
from dataloaders.ImageFolderDataset import ImageFolderDataset  
...
class ImageFolderDataModule(pl.LightningDataModule):
    def __init__(self,
                 ...
                 shuffle_all=False,
                 image_size=(480, 640),
                 crop_size=(500, 1000, 2000),
                 num_workers=4,
                 show_data_stats=True, 
                 mean_std=IMAGENET_MEAN_STD,
                 batch_sampler=None,
                 random_sample_from_each_place=True,
                 val_set_names=['tzb_val', 'tzb_val2']
                 ):
        super().__init__()
    ...
    def setup(self, stage):
        if stage == 'fit':
            ...
            for valid_set_name in self.val_set_names:
                if 'taizhou_val' in valid_set_name.lower():
